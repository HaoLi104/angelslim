...
class EvaluationConfig:
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.use_confusion_prune = args.use_confusion_prune
        self.confusion_window = args.confusion_window
        self.confusion_threshold = args.confusion_threshold
...
def initialize_model(config: EvaluationConfig) -> Eagle3Model:
    ...
    model = Eagle3Model.from_pretrained(
        ...
        use_confusion_prune=config.use_confusion_prune,
        confusion_window=config.confusion_window,
        confusion_threshold=config.confusion_threshold,
    )
    model.eval()
