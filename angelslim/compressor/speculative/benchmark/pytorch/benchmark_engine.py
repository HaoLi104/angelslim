...
class BenchmarkEngine:
    ...
    def _create_args_namespace(self, mode: str) -> argparse.Namespace:
        ...
        args.use_confusion_prune = self.config.use_confusion_prune
        args.confusion_window = self.config.confusion_window
        args.confusion_threshold = self.config.confusion_threshold
